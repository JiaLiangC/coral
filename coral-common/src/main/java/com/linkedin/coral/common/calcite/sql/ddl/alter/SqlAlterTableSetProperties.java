...
public class SqlAlterTableSetProperties extends SqlCall {
    private final SqlNodeList properties;

    public SqlAlterTableSetProperties(SqlParserPos pos, SqlNodeList properties) {
        super(pos);
    ...
    public SqlOperator getOperator() {
        return new SqlSpecialOperator("ALTER TABLE", SqlKind.ALTER_TABLE) {
            ...
            public SqlCall createCall(@Nullable SqlLiteral functionQualifier,
                ...
                return new SqlAlterTableSetProperties(pos, properties);
            }
        };
    }
